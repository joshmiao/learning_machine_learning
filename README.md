...
>
> 除了试图完成通用的验证码识别程序，我们还可以对于特定网站生成相似的验证码图像，利用机器学习Tensorflow框架实现OCR识别模型创建针对性的模型对于网站的验证码进行预测。
...
## 7. 项目总结及完成度自我评价
>可见，识别效果对于“特效拉满”的验证码不尽人意，主要是源于颜色的干扰；对于为训练过的验证码类别识别率较低，即使其相对于训练集的识别难度简单很多，程序通用性较差。 
>
